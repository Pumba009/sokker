...
import { loadPlayersStatsFromStorageViaMassage, savePlayersStatsToStorageViaMassage } from '../utils/storage_helper';
...
export class StorageManager implements IStorageManager {
    ...
    private async updateAllPlayers(playersStatsFromPage: IPlayersPage[], dataFromStorage: IPlayersData) {
    ...
    private getPlayerByName(playerName: string, playersFromStorage: IPlayerDetails[]): Player | undefined {
